...
class VideoLibrary:
    ...
    def get_video(self, video_id):
        ...
        Returns:
            ...
            does not exist.
        """
##        video_list=list(self._videos.values())
##
##        count=0
##        for i in range(len(video_list)):
##            if video_list[count]._video_id == video_id:
##                self._videos=(video_list[count]._title, video_list[count]._video_id, video_list[count]._tags)
##                break
##            else:
##                x = None
##            count=count+1
